...
#ifndef PRODUCT
  virtual void print_name(outputStream* out) const { out->print("ShenandoahPrefetchBarrierStub"); }
#endif // PRODUCT
};
...
private:
  ...
  void prefetch_barrier(LIRGenerator* gen, LIR_Opr obj, CodeEmitInfo* info, DecoratorSet decorators, bool need_null_check);
  void prefetch_barrier_impl(LIRGenerator* gen, LIR_Opr obj, CodeEmitInfo* info, DecoratorSet decorators, bool need_null_check);
